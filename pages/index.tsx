  ...
  return (
    <div className="flex flex-col items-center justify-center my-10">
      ...
      <div className="flex flex-col md:flex-row gap-4 mt-8">
        <Link href={data.links.articles} className="flex items-center justify-center bg-blue-800 hover:bg-blue-900 text-white text-lg font-medium px-6 py-3 rounded-lg">
          <FiArrowRight className="mr-2" /> Read My Blog
        </Link>
        <a href={data.social.youtube} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center bg-red-800 hover:bg-red-900 text-white text-lg font-medium px-6 py-3 rounded-lg">
